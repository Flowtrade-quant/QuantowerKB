...
* [**How to customize the Main Toolbar**](./#customization-of-main-toolbar)
* [**Main menu with all panels**](./#sidebar)
* [**How to add Favorite Panels on the Toolbar**](./#favorite-panels)
* [**How to Lock Trading**](./#lock-trading)
* [**How to create and manage your Workspaces**](./#workspaces-manager)
* [**Managing trading connections**](./#favorite-connections)
* [**Sidebar with all Notifications**](./#notifications-center)
* [**Platform's General Settings**](./#general-settings)
* [**Time & Time Zones**](./#time-and-time-zones)
