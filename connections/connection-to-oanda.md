...
&#x20;   5\. Launch **** [**FlowTrade platform**](https://www.flowtrade.com/) **** and select OANDA from the connection list. Choose demo or real connection and insert the API key.

![Connect to OANDA using your API key](../.gitbook/assets/connection-to-oanda-via-FlowTrade.png)
