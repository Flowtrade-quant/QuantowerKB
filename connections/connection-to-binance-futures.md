...
* \*\*\*\*[**How to connect to Binance Futures in FlowTrade platform**](connection-to-binance-futures.md#how-to-connect-to-binance-futures-in-FlowTrade-platform)\*\*\*\*
* \*\*\*\*[**How to change Leverage and Margin Type**](connection-to-binance-futures.md#how-to-change-leverage-and-margin-type)\*\*\*\*
* \*\*\*\*[**How to get Full License of FlowTrade for free with Binance?**](connection-to-binance-futures.md#how-to-get-full-license-of-FlowTrade-for-free-with-binance)\*\*\*\*
...
![Binance Futures error in FlowTrade - Timestamp for the request](../.gitbook/assets/image%20%2889%29.png)
