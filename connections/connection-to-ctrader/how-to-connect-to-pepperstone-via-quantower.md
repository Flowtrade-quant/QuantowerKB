# How to connect to Pepperstone via FlowTrade

To connect FlowTrade platform to Pepperstone broker and send trading orders, you need to use cTrader Gateway. If you already have a trading account with Pepperstone, then go to the penultimate step in this manual.
...
* After filling out the form and successful registration, you will be assigned a demo account number for MT platform. To connect FlowTrade to Pepperstone broker, you must create a demo for cTrader.
...
* Before connecting for the first time through FlowTrade platform, you need to activate your account in the cTrader system. You can do it via Pepperstone **cTrader Web-based** platform [https://ct.pepperstone.com/](https://ct.pepperstone.com/)
...
* You can place and manage your orders via FlowTrade or cTrader. Good luck!
