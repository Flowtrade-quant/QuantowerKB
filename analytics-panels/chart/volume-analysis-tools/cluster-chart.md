...
![Here is how you can activate Cluster chart in FlowTrade platform](<../../../.gitbook/assets/cluster activation.gif>)

{% hint style="info" %}
For more efficient analysis with cluster chart, you can display two different data types on one bar at once.
{% endhint %}

### Types of Cluster chart in FlowTrade

FlowTrade provides 3 types of cluster charts for better data visualization:

![Types of cluster charts (footprint) in FlowTrade](<../../../.gitbook/assets/image (360) (1).png>)
...
![Cluster chart in FlowTrade with single type visualization](<../../../.gitbook/assets/image (357) (1) (1) (1).png>)
...
![Cluster chart in FlowTrade with a double type visualization](<../../../.gitbook/assets/image (361) (1).png>)
...
![Cluster chart in FlowTrade with an Imbalance view](<../../../.gitbook/assets/image (359) (1) (1) (1).png>)
